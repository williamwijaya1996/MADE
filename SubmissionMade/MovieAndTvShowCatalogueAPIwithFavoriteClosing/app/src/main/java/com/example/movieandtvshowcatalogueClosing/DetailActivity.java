...
public class DetailActivity extends AppCompatActivity {
    ...
    private MoviesFavorite movieFavorite;
    ...
    private void init(){
        ...
        movieFavorite = new MoviesFavorite();
        ...
        if(uri != null){
            ...
            if(cursor != null){
                if(cursor.moveToFirst()) movieFavorite = new MoviesFavorite(cursor);
                cursor.close();
            }
        }
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    if(from.equals(EXTRA_FROM_MOVIE)) {
                        ...
                        values.put(DatabaseContract.FavoriteColumn.TITLE,movies.get(position).getTitle());
                        values.put(DatabaseContract.FavoriteColumn.DATE,movies.get(position).getRelease_date());
                        values.put(DatabaseContract.FavoriteColumn.POSTER,movies.get(position).getPoster_path());
                        values.put(DatabaseContract.FavoriteColumn.POPULARITY,movies.get(position).getPopularity());
                        values.put(DatabaseContract.FavoriteColumn.ID,movies.get(position).getId());

                        getContentResolver().insert(DatabaseContract.FavoriteColumn.CONTENT_URI_MOVIES,values);
                        ...
                        ContentValues values = new ContentValues();
                        values.put(DatabaseContract.FavoriteColumn.TITLE,moviesFavorite.get(position).getTitle());
                        values.put(DatabaseContract.FavoriteColumn.DATE,moviesFavorite.get(position).getRelease_date());
                        values.put(DatabaseContract.FavoriteColumn.POSTER,moviesFavorite.get(position).getPoster_path());
                        values.put(DatabaseContract.FavoriteColumn.POPULARITY,moviesFavorite.get(position).getPopularity());
                        values.put(DatabaseContract.FavoriteColumn.ID,moviesFavorite.get(position).getId());
                    ...
                    if(from.equals(EXTRA_FROM_MOVIE)){
                        ...
                        Log.d("getIntent",getIntent().getData()+"");
